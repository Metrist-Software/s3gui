defmodule S3GuiData.Aws.Regions do
  def regions(), do: ["us-east-1", "us-east-2", "us-west-1", "us-west-2",
    "us-gov-east-1", "us-gov-west-1", "af-south-1", "ap-east-1", "ap-northeast-1", "ap-northeast-2",
